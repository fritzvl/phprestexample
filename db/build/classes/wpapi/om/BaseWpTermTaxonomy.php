...
abstract class BaseWpTermTaxonomy extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->term_taxonomy_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            $this->parent = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->count = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
