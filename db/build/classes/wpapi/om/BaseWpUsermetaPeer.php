...
abstract class BaseWpUsermetaPeer
{
     ...
     * e.g. WpUsermetaPeer::$fieldNames[WpUsermetaPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (WpUsermetaPeer::UMETA_ID, WpUsermetaPeer::USER_ID, WpUsermetaPeer::META_KEY, WpUsermetaPeer::META_VALUE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. WpUsermetaPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (WpUsermetaPeer::UMETA_ID => 0, WpUsermetaPeer::USER_ID => 1, WpUsermetaPeer::META_KEY => 2, WpUsermetaPeer::META_VALUE => 3, ),
    ...
    {
        $toNames = WpUsermetaPeer::getFieldNames($toType);
        $key = isset(WpUsermetaPeer::$fieldKeys[$fromType][$name]) ? WpUsermetaPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(WpUsermetaPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, WpUsermetaPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return WpUsermetaPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(WpUsermetaPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(WpUsermetaPeer::DATABASE_NAME);
     ...
     *
     * @param      WpUsermeta $obj A WpUsermeta object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            WpUsermetaPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(WpUsermetaPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(WpUsermetaPeer::$instances[$key])) {
                return WpUsermetaPeer::$instances[$key];
            }
        }
    ...
    {
        WpUsermetaPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(WpUsermetaPeer::DATABASE_NAME)->getTable(WpUsermetaPeer::TABLE_NAME);
    }
    ...
    {
        return WpUsermetaPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(WpUsermetaPeer::UMETA_ID) && $criteria->keyContainsValue(WpUsermetaPeer::UMETA_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.WpUsermetaPeer::UMETA_ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(WpUsermetaPeer::DATABASE_NAME);
