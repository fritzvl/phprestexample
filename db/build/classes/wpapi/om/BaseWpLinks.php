 ...
 */
abstract class BaseWpLinks extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'WpLinksPeer';
    ...
    /**
     * Initializes internal state of BaseWpLinks object.
     * @see        applyDefaults()
     */
     ...
     * @return WpLinks The current object (for fluent API support)
     */
    public function setLinkId($v)
    {
        ...
        if ($this->link_id !== $v) {
            $this->link_id = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_ID;
        }
    ...
    public function setLinkUrl($v)
    {
        ...
        if ($this->link_url !== $v) {
            $this->link_url = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_URL;
        }
    ...
    public function setLinkName($v)
    {
        ...
        if ($this->link_name !== $v) {
            $this->link_name = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_NAME;
        }
    ...
    public function setLinkImage($v)
    {
        ...
        if ($this->link_image !== $v) {
            $this->link_image = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_IMAGE;
        }
    ...
    public function setLinkTarget($v)
    {
        ...
        if ($this->link_target !== $v) {
            $this->link_target = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_TARGET;
        }
    ...
    public function setLinkDescription($v)
    {
        ...
        if ($this->link_description !== $v) {
            ...
            $this->modifiedColumns[] = WpLinksPeer::LINK_DESCRIPTION;
        }
    ...
    public function setLinkVisible($v)
    {
        ...
        if ($this->link_visible !== $v) {
            $this->link_visible = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_VISIBLE;
        }
    ...
    public function setLinkOwner($v)
    {
        ...
        if ($this->link_owner !== $v) {
            $this->link_owner = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_OWNER;
        }
    ...
    public function setLinkRating($v)
    {
        ...
        if ($this->link_rating !== $v) {
            $this->link_rating = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_RATING;
        }
    ...
    public function setLinkUpdated($v)
    {
        ...
        if ($this->link_updated !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = WpLinksPeer::LINK_UPDATED;
            }
    ...
    public function setLinkRel($v)
    {
        ...
        if ($this->link_rel !== $v) {
            $this->link_rel = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_REL;
        }
    ...
    public function setLinkNotes($v)
    {
        ...
        if ($this->link_notes !== $v) {
            $this->link_notes = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_NOTES;
        }
    ...
    public function setLinkRss($v)
    {
        ...
        if ($this->link_rss !== $v) {
            $this->link_rss = $v;
            $this->modifiedColumns[] = WpLinksPeer::LINK_RSS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->link_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            $this->link_owner = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            return $startcol + 13; // 13 = WpLinksPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating WpLinks object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = WpLinksPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = WpLinksQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WpLinksPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(WpLinksPeer::LINK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_ID`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_URL)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_URL`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_NAME`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_IMAGE`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_TARGET)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_TARGET`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_DESCRIPTION`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_VISIBLE)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_VISIBLE`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_OWNER)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_OWNER`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_RATING)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_RATING`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_UPDATED`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_REL)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_REL`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`LINK_NOTES`';
        }
        if ($this->isColumnModified(WpLinksPeer::LINK_RSS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = WpLinksPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = WpLinksPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['WpLinks'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WpLinks'][$this->getPrimaryKey()] = true;
        $keys = WpLinksPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WpLinksPeer::LINK_ID)) $criteria->add(WpLinksPeer::LINK_ID, $this->link_id);
        if ($this->isColumnModified(WpLinksPeer::LINK_URL)) $criteria->add(WpLinksPeer::LINK_URL, $this->link_url);
        if ($this->isColumnModified(WpLinksPeer::LINK_NAME)) $criteria->add(WpLinksPeer::LINK_NAME, $this->link_name);
        if ($this->isColumnModified(WpLinksPeer::LINK_IMAGE)) $criteria->add(WpLinksPeer::LINK_IMAGE, $this->link_image);
        if ($this->isColumnModified(WpLinksPeer::LINK_TARGET)) $criteria->add(WpLinksPeer::LINK_TARGET, $this->link_target);
        if ($this->isColumnModified(WpLinksPeer::LINK_DESCRIPTION)) $criteria->add(WpLinksPeer::LINK_DESCRIPTION, $this->link_description);
        if ($this->isColumnModified(WpLinksPeer::LINK_VISIBLE)) $criteria->add(WpLinksPeer::LINK_VISIBLE, $this->link_visible);
        if ($this->isColumnModified(WpLinksPeer::LINK_OWNER)) $criteria->add(WpLinksPeer::LINK_OWNER, $this->link_owner);
        if ($this->isColumnModified(WpLinksPeer::LINK_RATING)) $criteria->add(WpLinksPeer::LINK_RATING, $this->link_rating);
        if ($this->isColumnModified(WpLinksPeer::LINK_UPDATED)) $criteria->add(WpLinksPeer::LINK_UPDATED, $this->link_updated);
        if ($this->isColumnModified(WpLinksPeer::LINK_REL)) $criteria->add(WpLinksPeer::LINK_REL, $this->link_rel);
        if ($this->isColumnModified(WpLinksPeer::LINK_NOTES)) $criteria->add(WpLinksPeer::LINK_NOTES, $this->link_notes);
        if ($this->isColumnModified(WpLinksPeer::LINK_RSS)) $criteria->add(WpLinksPeer::LINK_RSS, $this->link_rss);
    ...
    {
        $criteria = new Criteria(WpLinksPeer::DATABASE_NAME);
        $criteria->add(WpLinksPeer::LINK_ID, $this->link_id);
    ...
    {
        return (string) $this->exportTo(WpLinksPeer::DEFAULT_STRING_FORMAT);
    }
